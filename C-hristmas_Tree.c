...
#include <time.h>   //libreria p  ara rand y para la intermitencia del texto
...
#if defined(_WIN32) //si detecta el sistema operativo de windows se importara la libreria conio.h para la funcion kbhit usada para regresar al menu
...
#define COL 19 //numero de columnas
